...
<template>
  <div class="shrink-0 pt-3 mt-3 border-t border-[#e4e2de]/50 lg:mt-4 lg:pt-4">
    <div class="lg:rounded-2xl lg:border lg:border-[#e4e2de] lg:bg-[#f8f7f4] lg:p-5 lg:shadow-[0_12px_30px_rgba(45,52,48,0.05)]">
