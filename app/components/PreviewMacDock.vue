...
<template>
  <div class="h-36 rounded-xl overflow-hidden shadow-[0_4px_16px_rgba(45,52,48,0.06)] border border-[#e4e2de] transition-colors relative flex flex-col justify-end bg-[url('https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=beautiful%20macOS%20wallpaper%2C%20abstract%20gradient%20landscape%2C%20high%20detail&image_size=landscape_16_9')] bg-cover bg-center">
    ...
    <div class="w-full flex justify-center pb-2 relative z-10">
      <!-- Dock Container -->
      <div class="relative z-10 mb-3 px-3 py-1.5 self-center bg-white/20 backdrop-blur-2xl border border-white/20 rounded-2xl flex items-center gap-2 shadow-[0_12px_40px_rgba(0,0,0,0.15)]">
        <!-- Dock Items -->
        <div class="w-10 h-10 bg-gradient-to-br from-slate-100 to-slate-300 rounded-xl shadow-sm flex items-center justify-center shrink-0">
          <Settings :size="20" class="text-slate-600" />
        </div>
        <div class="w-10 h-10 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-xl shadow-sm flex items-center justify-center shrink-0">
          <MessageSquare :size="20" class="text-white" />
        </div>
        <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl shadow-sm flex items-center justify-center shrink-0 relative overflow-hidden">
          <Compass :size="22" class="text-white" />
        </div>
        <div class="w-10 h-10 bg-gradient-to-br from-sky-300 to-sky-500 rounded-xl shadow-sm flex items-center justify-center shrink-0">
        ...
        <div class="relative group">
          ...
          <div class="w-10 h-10 shrink-0 transition-transform duration-200 group-hover:-translate-y-2 group-hover:scale-110">
        ...
        <div class="w-10 h-10 bg-white rounded-xl shadow-sm flex flex-col items-center justify-center shrink-0 border border-slate-200">
