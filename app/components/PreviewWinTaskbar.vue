...
<template>
  <div class="h-48 rounded-xl overflow-hidden shadow-[0_4px_16px_rgba(45,52,48,0.06)] border border-[#e4e2de] transition-colors relative flex flex-col justify-end bg-[url('https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=beautiful%20windows%2011%20wallpaper%2C%20blue%20bloom%2C%20abstract%20ribbons%2C%20high%20detail&image_size=landscape_16_9')] bg-cover bg-center">
    ...
    <div class="h-12 w-full bg-[#f3f3f3]/80 backdrop-blur-2xl relative z-10 flex items-center justify-center border-t border-white/60 shadow-[0_-1px_10px_rgba(0,0,0,0.05)]">
      ...
      <div class="w-10 h-10 rounded hover:bg-white/40 flex items-center justify-center transition-colors cursor-pointer mr-1">
        <Grid2x2 :size="22" color="#0078d4" />
      </div>
      
      <!-- Search Button -->
      <div class="w-10 h-10 rounded hover:bg-white/40 flex items-center justify-center transition-colors cursor-pointer mx-1 text-slate-700">
        <Search :size="20" />
      </div>

      <!-- Generated Icon App -->
      <div class="w-10 h-10 rounded hover:bg-white/40 flex items-center justify-center transition-colors cursor-pointer mx-1 relative group">
        <div class="absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-slate-800 font-medium text-xs px-3 py-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-md border border-slate-200">
          App
        </div>
      ...
      <div class="absolute right-2 flex items-center h-full gap-1 text-xs text-slate-800">
        <div class="px-2 h-10 rounded hover:bg-white/40 flex items-center justify-center transition-colors cursor-pointer gap-2">
          <!-- Tray Icon Preview -->
        ...
        <div class="px-2 h-10 rounded hover:bg-white/40 flex flex-col items-end justify-center transition-colors cursor-pointer text-[10px] leading-tight text-right font-medium">
          <span>10:00 AM</span>
